        ...
        if (id <= jumlahPesanan) {
            ...
            if (id == 1 && jumlahPesanan >= 1) {
                ...
                if (item == 1) {
                    ...
                    history1.cara.setText("Rp " + pesanan[6]);
                    history1.harga.setText(pesanan[7]);
                    history1.status.setText(pesanan[8]);
                } else if (item == 2) {
                    history2.setVisible(true);
                    history2.jumlah.setText(pesanan[5] + " pcs");
                    history2.cara.setText(pesanan[7]);
                    history2.harga.setText("Rp "  + pesanan[6]);
